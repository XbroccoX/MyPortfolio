        ...
        <section id='aboutme'>
            <div className="flex flex-col md:flex-row">
                ...
                <div className="flex flex-col md:md:w-2/3 text-gray-700">
                    ...
                    <p className="mb-4">
                        Experienced front-end developer with expertise in React.js, Next.js, and Adobe Experience Manager.
                        Skilled in creating dynamic and responsive web applications that deliver intuitive user experiences. Strong
                        problem-solving and communication skills, with the ability to work effectively both independently and as part of
